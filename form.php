                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        Edit Data Mahasiswa <strong> <?= $mhs["nama"] ?></strong>
                                    </div>
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <img src="img/<?= $mhs["gambar"] ?>" width="130">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="nim" name="nim" readonly value="<?= $mhs["nim"] ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="nama" name="nama" value="<?= $mhs["nama"] ?>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="email" name="email" value="<?= $mhs["email"] ?>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="jurusan" id="jurusan" class="form-control">
                                                        ...
                                                        <option value="Teknik Mesin" <?php if($mhs["jurusan"] == "Teknik Mesin") echo 'selected="selected"'; ?> >Teknik Mesin</option>
                                                        <option value="Teknik Elektro" <?php if($mhs["jurusan"] == "Teknik Elektro") echo 'selected="selected"'; ?> >Teknik Elektro</option>
                                                        <option value="Teknik Sipil" <?php if($mhs["jurusan"] == "Teknik Sipil") echo 'selected="selected"'; ?> >Teknik Sipil</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
